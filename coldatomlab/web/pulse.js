...
(() => {
  ...
  function report(p,ref,records,status){return {schema:"coldatomlab-pulse-v1",version:"0.13.0",convention,plan:p,status,windows:windows(p),checkpoints:checkpoints(p),reference:ref,records,aggregate:aggregate(p,ref,records)};}
