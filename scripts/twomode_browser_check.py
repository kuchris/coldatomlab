...
def capture(page, name):
    with page.expect_download() as event:
        page.frame_locator("#quantum-frame").locator("#tm-json").click()
...
def complete(page):
    ...
    expect(page.frame_locator("#quantum-frame").locator("#tm-status")).to_contain_text(
        "Complete", timeout=20000
    )


def recipe(page, name):
    page.frame_locator("#quantum-frame").locator(f'[data-preset="{name}"]').click()
    page.frame_locator("#quantum-frame").get_by_role(
        "button", name="Prepare experiment", exact=True
    ).click()
...
def exercise(browser, url, prefix):
    ...
    page.on("request", lambda r: requests.append(r.url) if "quantum.html" in r.frame.url else None)
    page.goto(url + "/quantum.html", wait_until="networkidle")
    expect(page.frame_locator("#quantum-frame").locator("#tm-status")).to_contain_text("Ready")
    assert page.frame_locator("#quantum-frame").locator("#tm-coherence").inner_text() == "0.000"
    page.frame_locator("#quantum-frame").locator("#tm-run").click()
    ...
    page.frame_locator("#quantum-frame").locator("#tm-step").click()
    assert page.frame_locator("#quantum-frame").locator("#tm-time").inner_text() != time
    page.frame_locator("#quantum-frame").locator("#tm-sample").click()
    measured = capture(page, prefix + "-paused")
    page.frame_locator("#quantum-frame").locator("#tm-sample").click()
    repeated = capture(page, prefix + "-repeat")
    assert repeated == measured
    page.frame_locator("#quantum-frame").locator("#tm-seed").fill("18")
    page.frame_locator("#quantum-frame").locator("#tm-sample").click()
    ...
    page.frame_locator("#quantum-frame").locator("#tm-shots").fill("0")
    page.frame_locator("#quantum-frame").locator("#tm-sample").click()
    expect(page.frame_locator("#quantum-frame").locator("#tm-status")).to_have_class("error")
    page.frame_locator("#quantum-frame").locator("#tm-shots").fill("1000")
    page.frame_locator("#quantum-frame").locator("#tm-atoms").fill("2.5")
    page.frame_locator("#quantum-frame").get_by_role(
        "button", name="Prepare experiment", exact=True
    ).click()
    assert (
        not page.frame_locator("#quantum-frame")
        .locator("#tm-atoms")
    ...
    page.frame_locator("#quantum-frame").locator("#tm-reset").click()
    assert page.frame_locator("#quantum-frame").locator("#tm-left").inner_text() == "40.00"
    expect(page.frame_locator("#quantum-frame").locator("#tm-status")).to_contain_text("pending")
    ...
    page.frame_locator("#quantum-frame").locator("#tm-pin").click()
    recipe(page, "narrow")
    complete(page)
    page.frame_locator("#quantum-frame").locator("#tm-sample").click()
    ...
    with page.expect_download() as event:
        page.frame_locator("#quantum-frame").locator("#tm-csv").click()
    ...
    for width in [390, 320]:
        ...
        assert (
            page.frame_locator("#quantum-frame")
            .locator("#tm-distribution svg")
            .bounding_box()["width"]
            >= 200
        )
        page.screenshot(path=str(OUT / f"{prefix}-mobile-{width}.png"), full_page=True)
    page.set_viewport_size({"width": 1440, "height": 1000})
    page.frame_locator("#quantum-frame").locator("#tm-clear").click()
    expect(page.frame_locator("#quantum-frame").locator("#tm-reference")).to_contain_text(
        "No pinned reference"
    )
    recipe(page, "fock")
    assert (
        page.frame_locator("#quantum-frame").locator("#tm-phase-value").inner_text()
        == "Unavailable"
    )
    page.frame_locator("#quantum-frame").locator("#tm-sample").click()
    ...
    page.frame_locator("#quantum-frame").locator("#tm-atoms").fill("100")
    page.frame_locator("#quantum-frame").locator("#tm-tunnelling_hz").fill("20")
    page.frame_locator("#quantum-frame").locator("#tm-interaction_hz").fill("2")
    page.frame_locator("#quantum-frame").get_by_role(
        "button", name="Prepare experiment", exact=True
    ).click()
    page.frame_locator("#quantum-frame").locator("#tm-step").click()
